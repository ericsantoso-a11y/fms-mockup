...
export default function Header({ breadcrumbs }: HeaderProps) {
  ...
  const isDriverCallup = pathname.startsWith("/driver-callup");
  ...
  return (
    <div className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-6 flex-shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        {isDriverCallup && (
          <a
            href="https://docs.google.com/document/d/1w_jAYS4HPlcqXnNY0VfHAqROjbhTJdqs7S9SCRFVhio/edit?tab=t.0#heading=h.r0gdxsbxv8xb"
            target="_blank"
            rel="noopener noreferrer"
            className="border border-gray-300 text-gray-600 hover:bg-gray-50 text-xs font-medium px-3 py-1.5 rounded transition-colors flex items-center gap-1.5"
          >
