...
export default function WorkspaceDetailPage() {
  ...
  return (
    ...
    >
      {/* Cancel FMSLayout's p-6 and go full-bleed two-column */}
        ...
        <div className="flex-1 overflow-y-auto p-6 min-w-0">
          ...
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="px-3 py-1.5 text-xs rounded border border-gray-300 text-gray-600 hover:bg-gray-50 transition-colors">
                Show Key
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-5">
            ...
            {activeTab === "respond" && (
              <div className="space-y-3">
                ...
                <div className="flex justify-end">
                  <button className="px-4 py-1.5 text-sm bg-red-600 text-white rounded hover:bg-red-700 transition-colors">
                    Submit Response
                  </button>
                </div>
              </div>
            ...
            {activeTab === "comment" && (
              <div className="space-y-3">
                <textarea
                  rows={4}
                  placeholder="Add an internal comment (not visible to external parties)…"
                  className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm text-gray-800 placeholder-gray-400 resize-none focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                />
                <div className="flex justify-end">
                  <button className="px-4 py-1.5 text-sm bg-gray-700 text-white rounded hover:bg-gray-800 transition-colors">
                    Add Comment
                  </button>
                </div>
              </div>
